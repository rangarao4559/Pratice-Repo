({
	doinit : function(component, event, helper) {
        ...
        if(pageReference){
            var state=pageReference.state.c__BeerId;
      
            component.set('v.beerId',state);
        ...
        component.find("newRecordCreator").getNewRecord(
            ...
            $A.getCallback(function(){
                var record=component.get("v.newRecordObject");
                var error=component.get("v.newRecordError");
                if(error ||(record===null)){
                    console.log("Error initializing record type:"+error);
                    
                }else{
                    console.log("template initialized:"+record.sObjectType);
                }
            })
    ...
    handlesubmit : function(component, event, helper) {
     ...
     var beerRecord=component.get('v.simpleRecord') ;
               ...
               console.log(beerRecord.Price__c);
...
alert(userId);
        ...
        component.set('v.beerOrder.Ordered_By_del__c', userId); 
